    ...
    (
        ...
        [
            ...
            Target(
                ...
                alphanumeric="I",
                alphanumeric_color=Color.BROWN,
            ),
            Target(
                x=3201,
                y=648,
                ...
                orientation=0.0,
                confidence=1,
                shape=Shape.QUARTER_CIRCLE,
                background_color=Color.BLUE,
                alphanumeric="D",
                alphanumeric_color=Color.GREEN,
            ),
            Target(
                x=1250,
                y=1652,
            ...
            Target(
                ...
                background_color=Color.BLACK,
                alphanumeric="E",
                alphanumeric_color=Color.YELLOW,
            ),
            Target(
                x=1203,
                y=651,
...
def _test_targets(actual_targets, expected_targets):
    ...
    found_acc = found / len(expected_targets)
    ...
    overall_acc = sum([v / len(expected_targets) for v in correct_cnts]) / 4

    print(
        "Accuracy - Found: {}%, Classification: {}%".format(
            found_acc * 100, overall_acc * 100
        )
    )

    assert found_acc > 0.01
    assert overall_acc > 0.01  # set low due to poor color classification
